...
///////
// LoopStatementList::LoopStatementList():slist() {}
// LoopStatementList::~LoopStatementList() {}
// void LoopStatementList::add(Stm* s) { slist.push_back(s);  }
// int LoopStatementList::accept(ImpVisitor* v) {
//   return v->visit(this);
// }
// void LoopStatementList::accept(TypeVisitor* v) {
//   return v->visit(this);
// }
///////
